...
$staticPages = [
    '/about' => [
        ...
        'data' => $pageData(
            'About Covenant Rise',
            'About Covenant Rise',
            'A Christ-centered ministry committed to raising a generation that walks in truth, power, and divine purpose.',
            'Covenant Rise exists to equip believers through sound teaching, spiritual insight, and the uncompromised Word of God.',
            'Learn about Covenant Rise, our vision, mission, beliefs, and leadership.',
            [],
            null,
            null,
            null,
